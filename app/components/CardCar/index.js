    ...
    <Grid.Column className='contentCardCar'>
      <Card className="cardCar">
        <Card.Content className='contentReserve'>
          <Image floated='right' className='imgMarca' src='https://s3-us-west-2.amazonaws.com/projuv-data/creatuviaje/images/Dollar.png' />
          <Card.Header>
            Ford KA
          </Card.Header>
          <div className='contentCarPrice'>
            <div className='contentImgCar'>
              <img className='imgCar' src='https://s3-us-west-2.amazonaws.com/projuv-data/creatuviaje/images/generic-car.png'/>
            </div>
