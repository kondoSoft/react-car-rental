      ...
      <Container fluid className='slider'>
        <Container className= 'containerFormSearch' fluid>
          ...
          <div className='ui container containerForm'>
            <FormSearch title="Bienvenido" validation={props.validationData} loading={props.loading} loadingTrue={props.loadingTrue}  saveDate={props.saveDate} saveLocation={props.saveLocation}/>
          </div>
